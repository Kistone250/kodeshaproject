...
if(isset($_POST['submit'])){
	...
	$result = mysqli_query($conn, "SELECT * FROM registration WHERE uname = '$uname' OR email = '$uname'");
...
<form action="login.php" method="POST" autocomplete="off">
	...
	<p> Don't Have an Account?<a href="reg.php"><label>Register Here!!!</label></a></p>
</form>
</div>
	<div id="footer">
